  ...
  const controls = (
    <div className='flex items-center gap-6'>
      <div className='flex items-center gap-4'>
        ...
        <div className='flex flex-col items-end'>
          <span className='text-xs text-muted-foreground uppercase font-bold tracking-wider mb-1'>Pellets</span>
          <span className='font-mono font-bold text-2xl tabular-nums leading-none'>{pellets.toString().padStart(3, '0')}</span>
        </div>
      </div>
        ...
        <div className='flex flex-col items-center gap-6'>
          ...
          <div className='flex flex-col items-center gap-2'>
            <div className='flex items-center gap-2'>
              <span className='text-xs text-muted-foreground uppercase font-bold'>Move</span>
            ...
            <div className='flex items-center gap-2'>
              <span className='text-xs text-muted-foreground uppercase font-bold'>Restart</span>
              <Kbd>Space</Kbd>
            </div>
          </div>
          ...
          {gameOver && (
            <div className='flex flex-col items-center gap-2 animate-in fade-in zoom-in duration-500'>
              ...
              <div className='text-sm text-muted-foreground animate-pulse'>Press Space or click Restart</div>
            </div>
          )}
        </div>
